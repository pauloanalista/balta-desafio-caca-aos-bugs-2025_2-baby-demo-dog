...
namespace BugStore.Domain.Domain.Contracts.Repositories.Base
{
    ...
    where TId : struct
    {
        ...
        /// <summary>
        /// Lista entidade podendo realizar includes de objetos via String. Ex: var ticketCollection = _repositoryTicket.ListarPor("Cliente.Empresa");"
        /// </summary>
        ...
        /// <summary>
        /// Lista entidade ordenada podendo realizar includes de objetos via String. Ex: var ticketCollection = _repositoryTicket.ListarEOrdenadosPor(x=>x.Id=1, "Cliente.Empresa");"
        /// </summary>
        ...
        /// <summary>
        /// Lista entidsade podendo realizar includes de objetos via String. Ex: var ticketCollection = _repositoryTicket.Listar("Cliente.Empresa");"
        /// </summary>
